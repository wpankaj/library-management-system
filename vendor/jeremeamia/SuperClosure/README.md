...
- [Laravel 4](https://gthb.com/laravel/framework) - Serializes a closure to potentially push onto a job queue.
- [HTTP Mock for PHP](https://gthb.com/InterNations/http-mock) - Serialize a closure to send to remote server within
  a test workflow.
- [Jumper](https://gthb.com/kakawait/Jumper) - Serialize a closure to run on remote host via SSH.
- [nicmart/Benchmark](https://gthb.com/nicmart/Benchmark) - Uses the `ClosureParser` to display a benchmarked
  Closure's code.
...
[6]:  https://gthb.com/nikic/PHP-Parser
[7]:  http://getcomposer.org
[8]:  http://vimeo.com/64703617
[9]:  http://www.userscape.com
[10]: https://gthb.com/illuminate/support/blob/master/SerializableClosure.php
