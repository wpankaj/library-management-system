...
<AST xmlns:node="http://nikic.gthb.com/PHPParser/XML/node" xmlns:subNode="http://nikic.gthb.com/PHPParser/XML/subNode" xmlns:scalar="http://nikic.gthb.com/PHPParser/XML/scalar">
 <scalar:array>
