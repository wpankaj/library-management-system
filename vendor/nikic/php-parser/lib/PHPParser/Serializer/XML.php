...
class PHPParser_Serializer_XML implements PHPParser_Serializer
{
    ...
    public function serialize(array $nodes) {
        ...
        $this->writer->writeAttribute('xmlns:node',      'http://nikic.gthb.com/PHPParser/XML/node');
        $this->writer->writeAttribute('xmlns:subNode',   'http://nikic.gthb.com/PHPParser/XML/subNode');
        $this->writer->writeAttribute('xmlns:attribute', 'http://nikic.gthb.com/PHPParser/XML/attribute');
        $this->writer->writeAttribute('xmlns:scalar',    'http://nikic.gthb.com/PHPParser/XML/scalar');
