 ...
 * 2. See overview https://gthb.com/barbushin/php-console#overview
 * 3. Install PHP Console library https://gthb.com/barbushin/php-console#installation
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(array $options = array(), Connector $connector = null, $level = Logger::DEBUG, $bubble = true)
    {
        if (!class_exists('PhpConsole\Connector')) {
            throw new Exception('PHP Console library not found. See https://gthb.com/barbushin/php-console#installation');
        }
