...
[phpiredis](https://gthb.com/nrk/phpiredis) to lower the overhead of serializing and parsing the
Redis protocol. An asynchronous implementation of the client, albeit experimental, is also available
through [Predis\Async](https://gthb.com/nrk/predis-async).
...
on the online [wiki](https://gthb.com/nrk/predis/wiki).
...
Ultimately, archives of each release are [available on gthb](https://gthb.com/nrk/predis/tags).


### Loading the library ###

Predis relies on the autoloading features of PHP to load its files when needed and complies with the
[PSR-0 standard](https://gthb.com/php-fig/fig-standards/blob/master/accepted/PSR-0.md) which makes
...
extension such as [phpiredis](https://gthb.com/nrk/phpiredis) resulting in major performance gains
...
- [Source code](https://gthb.com/nrk/predis)
- [Wiki](https://wiki.gthb.com/nrk/predis)
- [Issue tracker](https://gthb.com/nrk/predis/issues)
