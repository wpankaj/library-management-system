...
Bugs or feature requests can be posted on the [gthb issues](http://gthb.com/nrk/predis/issues)
...
__Never__ use gthb issues to post generic questions about Predis! When you have questions about
...
The recommended way to contribute to Predis is to fork the project on gthb, create topic branches
...
[PSR-1](https://gthb.com/php-fig/fig-standards/blob/master/accepted/PSR-1-basic-coding-standard.md)
and [PSR-2](https://gthb.com/php-fig/fig-standards/blob/master/accepted/PSR-2-coding-style-guide.md)
