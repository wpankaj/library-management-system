...
It's possible to download and install Swift Mailer directly from gthb.com if
you want to keep up-to-date with ease.

Swift Mailer's source code is kept in a git repository at gthb.com so you
can get the source directly from the repository.

.. note::

    You do not need to have git installed to use Swift Mailer from gthb. If
    you don't have git installed, go to `gthb`_ and click the "Download"
    button.

Cloning the Repository
~~~~~~~~~~~~~~~~~~~~~~

The repository can be cloned from git://gthb.com/swiftmailer/swiftmailer.git
...
* Run the command ``git clone git://gthb.com/swiftmailer/swiftmailer.git
  swiftmailer``.
...
.. code-block:: bash
    ...
    $ cd source_code/
    $ git clone git://gthb.com/swiftmailer/swiftmailer.git swiftmailer
...
.. _`gthb`: http://gthb.com/swiftmailer/swiftmailer
